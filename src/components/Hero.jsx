...
function Hero() {
  ...
  return (
    ...
    //     <div key={index} >
    <div className="bg-blue-300 w-full h-[90vh] relative md:bg-left-top bg-cover bg-no-repeat bg-center">
      <div className="w-full h-full bg-black/20">
        <div className="relative max-w-7xl  mx-auto flex flex-col items-center md:items-start justify-between lg:px-6 px-3 py-3 h-full">
          <div className="absolute top-[50%] translate-y-[-50%] lg:left-[5%] flex flex-col w-fit gap-6 ">
            <h1 className="font-medium text-3xl md:text-4xl lg:text-3xl  text-black py-2 px-6 ">
              Hello, Welcome to Ohene-MediHub!
              <br />
