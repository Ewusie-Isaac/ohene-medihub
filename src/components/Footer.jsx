...
function Footer() {
  ...
  return (
    <div className="bg-green-400 w-full  text-center">
      <div className="max-w-screen-2xl mx-auto flex flex-col items-center justify-center px-3 space-y-9 pt-8">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="cols-span-1 md:col-span-4 text-left">
            ...
            <p className="text-md lg:text-lg  text-black/70 font-medium">
              Ohene-MediHub is a web-based platform facilitating seamless
              management of healthcare services, including appointments, patient
              records, and doctor interactions.
            </p>
            {/* icons */}
            <div className="flex items-center gap-4 mt-10">
              <div className=" border border-white/70 rounded-full px-2 py-2 hover:bg-slate-700/30 cursor-pointer">
                <a
                  href="http://www.linkedin.com/in/edmund-ohene-ankomah"
                  target="_blank"
                >
                  <FaInstagram />
                </a>
          ...
          >
            ...
            <button
              type="submit"
              className="grow bg-blue-500 text-white py-3 rounded-md"
            >
              Send Message
            </button>
          </form>
        ...
        <div className="w-full py-4">
          ...
          <p className="text-sm lg:text-[1rem] font-medium text-center">
            © {new Date().getFullYear()} Edmund Ohene. All rights reserved.
          </p>
        </div>
      </div>
    </div>
